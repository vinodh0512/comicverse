...
<head>
    ...
    <title>Manage Comics | ComicVerse Admin</title>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; }
        ...
        /* Table Elements */
        .comic-info { display: flex; align-items: center; gap: 15px; }
        .comic-thumb { width: 40px; height: 60px; object-fit: cover; border-radius: 2px; background: #333; }
        .comic-title { font-weight: 700; display: block; margin-bottom: 3px; color: #fff; }
        .comic-publisher { font-size: 12px; color: #888; }
        .comic-publisher span { color: #ec1d24; font-weight: 700; } /* Publisher Highlight */
        ...
        .status-limited { background: rgba(255, 153, 0, 0.15); color: #ff9900; border: 1px solid rgba(255, 153, 0, 0.3); } /* Limited Series */
        ...
        @media (max-width: 768px) {
            ...
            .comic-info { flex-direction: column; align-items: flex-start; gap: 5px; }
...
<div class="dashboard-container">
    ...
    <aside class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="#" class="active"><i class="fas fa-mask"></i> Manage Comics</a></li>
    ...
    <main class="main-content">
        ...
        <div class="top-bar">
            <div style="color:#888; font-size:14px;">
                Admin / Content / <span style="color:white;">Manage Comics</span>
            </div>
        ...
        <div class="content-wrapper">
            ...
            <div class="page-header">
                <div class="page-title">
                    <h2>Manage Comic Library</h2>
                    <p>Oversee Western comic books, issues, and limited series.</p>
                </div>
                <div style="display:flex; gap:20px;">
                    <div style="text-align:right;">
                        <div style="font-size:20px; font-weight:800;">3,500</div>
                        <div style="font-size:11px; color:#777; text-transform:uppercase;">Total Comics</div>
                    </div>
                    <div style="text-align:right;">
                        <div style="font-size:20px; font-weight:800; color:#00a652;">120</div>
                        <div style="font-size:11px; color:#777; text-transform:uppercase;">Issues this Week</div>
                    </div>
                </div>
            </div>

            <div class="controls-bar">
                <input type="text" class="search-input" placeholder="Search by title, publisher (Marvel, DC), or Writer...">
...
document.addEventListener('DOMContentLoaded', function(){
    var tbody=document.getElementById('comicBody');
    if(!tbody) return;
    tbody.innerHTML = '<tr><td colspan="8" style="text-align:center;color:#888;"><i class="fas fa-circle-notch fa-spin"></i> Loading comics...</td></tr>';
    fetch('../get_stories_api.php?t='+Date.now()).then(function(r){return r.json()}).then(function(d){
        ...
        var stories=(d.stories||[]).filter(function(s){ return (s.type||'').toLowerCase()==='comic'; });
        if(!stories.length){ tbody.innerHTML = '<tr><td colspan="8" style="text-align:center;color:#888;">No comics found</td></tr>'; return; }
        tbody.innerHTML='';
        stories.forEach(function(s,idx){
            var tr=document.createElement('tr');
            var statusBadge='<span class="status-badge status-ongoing">Ongoing</span>';
            tr.innerHTML = '<td>'+(idx+1)+'</td>'+
                '<td><div class="comic-info"><img src="'+(s.thumbnail||'')+'" class="comic-thumb" alt="Thumb"><div><a href="#" class="comic-title">'+(s.title||s.folder||'')+'</a><span class="comic-publisher"><span>COMIC</span></span></div></div></td>'+
                '<td>'+statusBadge+'</td>'+
                ...
                '<td><div class="action-buttons"><div class="btn-icon" title="Edit"><i class="fas fa-pen"></i></div><div class="btn-icon" title="Upload Issue"><i class="fas fa-upload"></i></div><div class="btn-icon delete" title="Delete"><i class="fas fa-trash"></i></div></div></td>';
